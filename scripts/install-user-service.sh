...
SCOPED_CREDENTIAL_TTL_MS="${WMUX_SCOPED_CREDENTIAL_TTL_MS:-}"
...
sed \
  ...
  -e "s#Environment=WMUX_SCOPED_CREDENTIAL_TTL_MS=.*#Environment=WMUX_SCOPED_CREDENTIAL_TTL_MS=${SCOPED_CREDENTIAL_TTL_MS}#" \
